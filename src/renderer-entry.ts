...
const criticalEnhancements: Enhancement[] = [
  { name: 'preferences-ui', load: () => import('./preferences-ui') },
  ...
  { name: 'local-ai-ui', load: () => import('./local-ai-ui') },
  ...
  { name: 'account-profile-ui', load: () => import('./account-profile-ui') },
  ...
  { name: 'mcp-mode-ui', load: () => import('./mcp-mode-ui') },
